...
<header class="header">
    ...
    <div class="navbar">
        <ul class="navbar-options">
            ...
            <div class="dropdown"><button style="color: #D1284C;" class="dropbtn">Cursos<i style="color: #D1284C;" class="ri-arrow-down-s-line"></i></button>
                <div class="dropdown-content">
                    <a href="ciencias-naturales.jsp">Curso de Ciencias Naturales</a>
                    <a style="color: #D1284C;" href="quimica-biologia.jsp">Curso de Quimica y Biologia </a>
    ...
    <h1>Registro</h1>
    <h2>Quimica y Biologia</h2><br><br>
        <section>
            <div class="form-box">
                <div class="form-value">
                    <form action="captura-quimica-biologia.jsp">
                        <div class="inputbox">
                        ...
                        <br><br><br>
                        <select name="date" id="fechasIni" required>
